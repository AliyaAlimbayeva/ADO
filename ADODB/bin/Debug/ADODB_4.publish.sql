...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_Orders_Products]...';
...
GO
PRINT N'Dropping Check Constraint unnamed constraint on [dbo].[Orders]...';


GO
ALTER TABLE [dbo].[Orders] DROP CONSTRAINT [CK__Orders__Status__2A4B4B5E];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Orders] ([Id], [Status], [CreatedDate], [UpdatedDate], [ProductId])
        SELECT   [Id],
                 [Status],
                 [CreatedDate],
                 [UpdatedDate],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Products] ([Id], [Name], [Description], [Weight], [Height], [Width], [Length])
        SELECT   [Id],
                 [Name],
                 [Description],
                 [Weight],
...
GO
PRINT N'Creating Check Constraint unnamed constraint on [dbo].[Orders]...';


GO
ALTER TABLE [dbo].[Orders] WITH NOCHECK
    ADD CHECK ([Status] IN ('NotStarted', 'Loading', 'InProgress', 'Arrived', 'Unloading', 'Cancelled', 'Done'));
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Orders'))
               AND [type] IN (N'F', N'C')
